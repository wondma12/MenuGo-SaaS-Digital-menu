      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center p-12">
        <div className="max-w-md text-center text-white">
          ...
          <p className="text-lg text-white/90 mb-8">
            Transform your restaurant's menu experience with our digital
            solution
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-black to-black rounded-2xl mb-4">

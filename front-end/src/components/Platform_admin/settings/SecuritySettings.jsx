  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-secondary">Configure global authentication policies and session management for platform safety.</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full border border-surface-variant rounded-lg p-4 focus:border-black outline-none transition-all text-base"
              min="8"
              max="32"
              type="number"
            />
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between py-4 border-b border-surface-variant">
            <div className="flex flex-col">
              ...
              <span className="text-sm text-secondary">Force new users to verify email before access.</span>
            </div>
            <ToggleSwitch
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex flex-col">
              ...
              <span className="text-sm text-secondary">Allows admins to temporarily lock access.</span>
            </div>
            <ToggleSwitch
              checked={formData.enableAccountSuspension}

    ...
    <>
      <div className="mb-4 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button label="Export" variant="secondary" onClick={handleExport} icon={Download} size="sm" />
          <Button label="Print" variant="secondary" onClick={handlePrint} icon={Printer} size="sm" />
        </div>
      </div>
        ...
        {selectedOrder && (
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t">
              ...
              <p className="text-sm text-gray-600">{selectedOrder.notes || "No special instructions"}</p>
            </div>
          </div>
        )}
      </Modal>

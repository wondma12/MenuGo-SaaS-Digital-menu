...
const presetColors = [
  "#000000", "#DC2626", "#059669", "#D97706", 
  "#7C3AED", "#DB2777", "#0284C7", "#EA580C",
  "#4F46E5", "#0891B2", "#65A30D", "#C026D3"
];

const ColorPicker = ({ currentColor, onColorChange, title = "Primary Color" }) => {
            ...
            <div>
              ...
              <div className="grid grid-cols-6 gap-3">
                {presetColors.map((color) => (
                  ...
                  >
                    {selectedColor === color && (
                      <Check size={16} className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white drop-shadow" />
                    )}
                  </button>
                ))}
              </div>

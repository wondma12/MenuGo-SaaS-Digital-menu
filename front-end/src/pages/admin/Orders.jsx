...
const Orders = () => {
  ...
  const filteredOrders = orders.filter(order => {
    ...
    if (filters.search && !order.id.includes(filters.search) && !order.tableNumber.toString().includes(filters.search)) return false;
    if (filters.date) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-blue-500">
          ...
          <p className="text-2xl font-bold text-blue-600">{stats.verifiedOrders}</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-indigo-500">
          ...
          <p className="text-2xl font-bold text-indigo-600">{stats.readyOrders}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4">
          ...
          <p className="text-3xl font-bold text-green-800">${stats.totalRevenue.toFixed(2)}</p>
        </div>
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4">
          <p className="text-sm text-blue-700">Average Order Value</p>
          <p className="text-3xl font-bold text-blue-800">${stats.avgOrderValue}</p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-blue-800 font-medium">Order Status Guide</p>

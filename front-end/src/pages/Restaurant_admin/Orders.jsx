...
const Orders = () => {
  ...
  const [stats, setStats] = useState({ pending: 0, preparing: 0, avgTime: "18m", efficiency: "94%" });
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <header className="sticky top-0 z-40 w-full border-b border-neutral-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-8 h-16 shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
          ...
          <div className="flex items-center space-x-6">
            <button aria-label="Notifications" title="Notifications" className="p-2 rounded-sm hover:bg-neutral-100 transition-all duration-200 text-neutral-400">
            ...
            <button aria-label="Account" title="Account" className="p-2 rounded-sm hover:bg-neutral-100 transition-all duration-200 text-neutral-400">
        ...
        <main className="flex-1 p-8 max-w-[1200px] mx-auto">
          ...
          <div className="flex justify-between items-end mb-6">
            <div>
              <h1 className="font-h1 text-h1 text-on-surface mb-xs">Active Orders</h1>
              <p className="font-body-md text-secondary">Monitor and manage real-time dining room flow.</p>
            </div>
            <div className="flex space-x-4">
              <OrderFilter statusFilter={statusFilter} onStatusChange={handleStatusChange} />
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 border border-neutral-200 rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
              <span className="font-label-caps text-label-caps text-secondary uppercase">Pending</span>
              <p className="font-display text-h1 mt-2">{stats.pending}</p>
            </div>
            <div className="bg-white p-6 border border-neutral-200 rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
              <span className="font-label-caps text-label-caps text-secondary uppercase">Preparing</span>
              <p className="font-display text-h1 mt-2">{stats.preparing}</p>
            </div>
            <div className="bg-white p-6 border border-neutral-200 rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
              <span className="font-label-caps text-label-caps text-secondary uppercase">Avg. Time</span>
              <p className="font-display text-h1 mt-2">{stats.avgTime}</p>
            </div>
            <div className="bg-white p-6 border border-neutral-200 rounded-lg shadow-[0_4px_12px_rgba(0,0,0,0.04)]">
              <span className="font-label-caps text-label-caps text-secondary uppercase">Efficiency</span>
            ...
            <div className="space-y-6">
              <div className="bg-black text-white p-6 rounded-xl relative overflow-hidden">
                ...
                <p className="text-neutral-400 font-body-sm mb-4">
                  Your restaurant is currently handling peak volume with {stats.efficiency} efficiency.
                </p>
              ...
              <div className="bg-white border border-neutral-200 p-6 rounded-xl">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    <span className="material-symbols-outlined text-neutral-400 text-lg">warning</span>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider">Delay Alert</p>
                      <p className="text-xs text-neutral-500">Table 04 dish exceeds 20m.</p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    <span className="material-symbols-outlined text-neutral-400 text-lg">check_circle</span>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider">Supply Check</p>
                      <p className="text-xs text-neutral-500">Inventory sync completed.</p>
                    </div>
                  </li>
                </ul>
              </div>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <RestaurantNameForm
            ...
            onUpdate={(name) =>
              setSettings({ ...settings, restaurantName: name })
            }
          />
          ...
          <BackgroundUpload
            ...
            onBackgroundUpdate={(bg) =>
              setSettings({ ...settings, backgroundImage: bg })
            }
          />
        </div>
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: settings.theme.darkMode
                          ...
                          : "#ffffff",
                        boxShadow:
                          settings.theme.cardStyle !== "shadow-none"
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <h3
                            className={`font-semibold ${settings.theme.darkMode ? "text-white" : "text-gray-900"}`}
                          >
                            {item.name}
                          </h3>
                          <p
                            className={`text-sm ${settings.theme.darkMode ? "text-gray-400" : "text-gray-500"}`}
                          >
                            {item.desc}
                          </p>
                        </div>
                      ...
                      <button
                        className={`mt-3 px-4 py-2 text-white text-sm transition-all ${
                          settings.theme.buttonStyle === "rounded"
                            ? "rounded"
                            : settings.theme.buttonStyle === "rounded-lg"
                              ? "rounded-lg"
                              : settings.theme.buttonStyle === "rounded-full"
                                ? "rounded-full"
                                : ""
                        }`}
                        style={{ backgroundColor: settings.primaryColor }}

...
import QRCard from '../../components/admin/dashboard/QRCard';
import StaffOnDuty from '../../components/admin/dashboard/StaffOnDuty';
import InventoryAlert from '../../components/admin/dashboard/InventoryAlert';

// Mock data
const mockOrders = [
  { id: '#ORD-2841', table: 'Table 04', status: 'Pending', amount: 124.50 },
  { id: '#ORD-2840', table: 'Table 12', status: 'Served', amount: 89.00 },
  { id: '#ORD-2839', table: 'Bar 02', status: 'Served', amount: 42.25 },
  { id: '#ORD-2838', table: 'Table 07', status: 'Pending', amount: 210.15 },
  { id: '#ORD-2837', table: 'Table 05', status: 'Served', amount: 67.80 },
];

const mockStaff = [
  { id: 1, name: 'Sarah Jenkins', role: 'Head Chef', avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCFxTJskQXd8v-ISTg0x0kDhLpo1OyNcamyrKEjIRuRHfG-XFI6qzmwHyWc0OoHEqxlQCGUU_TU7WhAUoXq367N_yARxvVzh9gcmtzERUhXNHRMa3qcyuXhSnz-RxjdbhxGnmj164uBS5L-x5ecALzzo7F6IqBbfcLCgBf4myDgHOOUMHMia-esCpnP4BqVjpgrROtJqg5v9kM3YkcpuDBSXOsLyNzrvNG3KAYc_VHVBxVRZ1qbth-yet7RNHQdqPPzWvvMpqQLdSM' },
  { id: 2, name: 'Marcus V.', role: 'Floor Manager', avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDiCFRx-t00NEybRarIbw3T_Tmuaq1r1_mvJ8zCxtV9Z7E7YRZPuQeXryfb2YzWvQlGWkrYxdqPUlp64Nun96lzwBqqlImFyFhZGo8LifkCOANQSJhH3766dVJS5y3kcvev5tt9Jl6WfU8Xt-dtwMlYjy-nk7x-LD4oM0bti-ADI1Yr5rd-WNlAKtu_7nqjcYshtg9dw24xlUGUqbU5EbZxpsuKRbUTa46HIxkBZN182vKL0FluHRUVG-Aoa9UFeAgMU9j9TNSxZ54' },
];
      ...
      <main className="min-h-screen pb-8">
        ...
        <header className="sticky top-0 z-40 w-full border-b border-neutral-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-8 h-16">
          ...
          <div className="flex items-center space-x-4">
            <button aria-label="Notifications" title="Notifications" className="p-2 hover:bg-neutral-100 rounded-sm transition-all duration-200 relative text-black">
            ...
            <button aria-label="Account" title="Account" className="p-2 hover:bg-neutral-100 rounded-sm transition-all duration-200 text-black">
        ...
        <section className="p-8 space-y-6 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-end justify-between">
            <div className="space-y-1">
              ...
              <p className="font-body-sm text-secondary">Real-time overview of your restaurant performance.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <RecentOrdersTable orders={orders} onViewAll={handleViewAllOrders} />
            </div>
